...
class StaffAttendencePageTable extends StatelessWidget {
  const StaffAttendencePageTable({super.key});
    ...
    return  SingleChildScrollView(
      ...
      child: DataTable(
        ...
        columns: const [
          ...
          DataColumn(
            label: CommonBlackTextTitleWidget(text: "Mobile Number"),
          ),
          DataColumn(
        ...
        child: Column(
          children: [
            const Row(
              ...
              children: [
                CommonBlackTextTitleWidget(text: "Staff Name"),
                CommonBlackTextTitleWidget(text: "Mobile Number"),
