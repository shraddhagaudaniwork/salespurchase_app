...
class WareHousePageTable extends StatelessWidget {
  const WareHousePageTable({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    //           children: [
    //             CommonBlackTextTitleWidget(text: "Item Warehouse Name"),
    //             CommonBlackTextTitleWidget(text: "Item Warehouse Code"),
    //           ],
    //         ),
    //         const Divider(),
    //         Padding(
