...
import 'package:salespurchase_app/views/screens/home/drawer/general/purchase/debitnotes/widgets/debitnotes_table.dart';
import 'package:salespurchase_app/views/screens/home/drawer/general/purchase/debitnotes/widgets/debitnotes_topheader.dart';
...
class DebitNotes_page extends StatelessWidget {
  const DebitNotes_page({super.key});
        ...
        child: Column(
          children: [
            Padding(
              ...
              child: const DebitNotesPageTopHeader(),
            ),
            Padding(
              padding: SizeConfig().getPadding(top: 15),
              child: const DebitNotesPageTable(),
            ),
            Spacer(),
            const Row(
