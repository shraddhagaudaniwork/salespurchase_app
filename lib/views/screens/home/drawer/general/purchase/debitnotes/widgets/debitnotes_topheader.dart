...
import 'package:salespurchase_app/views/screens/home/drawer/general/purchase/debitnotes/widgets/debitnotes_textformfield.dart';
...
class DebitNotesPageTopHeader extends StatelessWidget {
  const DebitNotesPageTopHeader({super.key});
    ...
    return Row(
      children: [
        Padding(
          ...
          child: const CommonDarkGreyTextTitleWidget(text: "Debit Notes"),
        ),
        width05,
        const DebitNotesPageTextFormField(),
      ],
    );
  }
}
