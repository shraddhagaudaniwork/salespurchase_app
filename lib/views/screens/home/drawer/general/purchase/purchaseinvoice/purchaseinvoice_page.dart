...
import 'package:salespurchase_app/views/screens/home/drawer/general/purchase/purchaseinvoice/widgets/purchaseinvoice_container.dart';
import 'package:salespurchase_app/views/screens/home/drawer/general/purchase/purchaseinvoice/widgets/purchaseinvoice_table.dart';
import 'package:salespurchase_app/views/screens/home/drawer/general/purchase/purchaseinvoice/widgets/purchaseinvoice_topheader.dart';
...
class PurchaseInvoice_page extends StatelessWidget {
  const PurchaseInvoice_page({super.key});
      ...
      body: Padding(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              const PurchaseInvoicePageContainer(),
              Padding(
                padding: SizeConfig().getPadding(top: 15),
                child: const PurchaseInvoicePageTopHeader(),
              ),
              Padding(
                padding: SizeConfig().getPadding(top: 15),
                child: const PurchaseInvoicePageTable(),
              ),
              const Row(
