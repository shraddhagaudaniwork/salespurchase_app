...
import 'package:salespurchase_app/views/screens/home/drawer/general/purchase/purchaseorders/widgets/purchaseorders_table.dart';
import 'package:salespurchase_app/views/screens/home/drawer/general/purchase/purchaseorders/widgets/purchaseorders_topheader.dart';
...
class PurchaseOrders_page extends StatelessWidget {
  const PurchaseOrders_page({super.key});
        ...
        child: Column(
          children: [
            Padding(
              ...
              child: const PurchaseOrdersPageTopHeader(),
            ),
            Padding(
              padding: SizeConfig().getPadding(top: 15),
              child: const PurchaseOrdersPageTable(),
            ),
           const Spacer(),
            const Row(
