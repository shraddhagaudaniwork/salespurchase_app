...
import 'package:salespurchase_app/views/screens/home/drawer/general/purchase/purchasereturn/widgets/purchasereturn_table.dart';
import 'package:salespurchase_app/views/screens/home/drawer/general/purchase/purchasereturn/widgets/purchasereturn_topheader.dart';
...
class PurchaseReturn_page extends StatelessWidget {
  const PurchaseReturn_page({super.key});
        ...
        child: Column(
          children: [
            Padding(
              ...
              child: const PurchaseReturnPageTopHeader(),
            ),
            Padding(
              padding: SizeConfig().getPadding(top: 15),
              child: const PurchaseReturnPageTable(),
            ),
            const Spacer(),
            const Row(
