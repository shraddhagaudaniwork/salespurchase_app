...
class PurchaseReturnPageTable extends StatelessWidget {
  const PurchaseReturnPageTable({super.key});
          ...
          children: [
            DataTable(
              ...
              columns: const [
                ...
                DataColumn(
                  label: CommonBlackTextTitleWidget(text: "Return Number"),
                ),
                DataColumn(
          ...
          children: [
            const Row(
              ...
              children: [
                ...
                CommonBlackTextTitleWidget(text: "Purchase Return"),
