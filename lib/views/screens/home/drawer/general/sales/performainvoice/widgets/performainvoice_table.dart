...
class PerformaInvoicePageTable extends StatelessWidget {
  const PerformaInvoicePageTable({super.key});
          ...
          children: [
            DataTable(
              ...
              columns: const [
                ...
                DataColumn(
                  label: CommonBlackTextTitleWidget(text: "Performa  Number"),
                ),
                DataColumn(
          ...
          children: [
            const Row(
              ...
              children: [
                ...
                CommonBlackTextTitleWidget(text: "Performa Invoice Number"),
