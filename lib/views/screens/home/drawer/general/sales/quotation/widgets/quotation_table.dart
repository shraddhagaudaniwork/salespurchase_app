...
class QuotationPageTable extends StatelessWidget {
  const QuotationPageTable({super.key});
  ...
  Widget build(BuildContext context) {
          ...
          children: [
            DataTable(
              ...
              columns: const [
                ...
                DataColumn(
                  label: CommonBlackTextTitleWidget(text: "Quotation Number"),
                ),
                DataColumn(
    ...
    //             CommonBlackTextTitleWidget(text: "Quotation Number"),
