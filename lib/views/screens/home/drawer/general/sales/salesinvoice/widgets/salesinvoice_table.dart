...
class SalesInvoicePageTable extends StatelessWidget {
  const SalesInvoicePageTable({super.key});
  ...
  Widget build(BuildContext context) {
          ...
          children: [
            DataTable(
              ...
              columns: const [
                ...
                DataColumn(
                  label: CommonBlackTextTitleWidget(text: "Number"),
                ),
                DataColumn(
    ...
    //               CommonBlackTextTitleWidget(text: "Invoice Number"),
