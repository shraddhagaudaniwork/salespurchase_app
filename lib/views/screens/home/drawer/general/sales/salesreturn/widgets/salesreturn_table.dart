...
class SalesReturnPageTable extends StatelessWidget {
  const SalesReturnPageTable({super.key});
  ...
  Widget build(BuildContext context) {
          ...
          children: [
            DataTable(
              ...
              columns: const [
                ...
                DataColumn(
                  label: CommonBlackTextTitleWidget(text: "Sales Number"),
                ),
                DataColumn(
    ...
    //             CommonBlackTextTitleWidget(text: "Sales Number"),
